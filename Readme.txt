...
* Appuyez sur F pour entrer dans le terminal un chemin vers un fichier contenant des triplets de nombres séparés par des espaces et/ou des sauts à la ligne afin de construire les contraintes de la grille à partir de ce fichier de la manière suivante :
    ...
    -Vous pouvez entrer exemple5.txt dans une grille 5x5 ou exemple6.txt dans une grille 6x6 ou exemple10.txt dans une grille 10x10, ce sont des ensembles de contraintes qui produisent chacun une seule solution
    -Les fichiers exemplei.txt sont des exemples dans des grilles ixi
